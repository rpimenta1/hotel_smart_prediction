...
class PredictCancellation(object):
    def __init__(self):
        # Caminho absoluto até a pasta 'parameter'
        base_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), '../../parameter'))

        self.average_ticket = pickle.load(open(os.path.join(base_dir, 'average_ticket_scaler.pkl'), 'rb'))
        self.avg_price_per_room = pickle.load(open(os.path.join(base_dir, 'avg_price_per_room_scaler.pkl'), 'rb'))
        self.lead_time = pickle.load(open(os.path.join(base_dir, 'lead_time_scaler.pkl'), 'rb'))
        self.market_segment_type = pickle.load(open(os.path.join(base_dir, 'market_segment_type_encoder.pkl'), 'rb'))
        self.price_category = pickle.load(open(os.path.join(base_dir, 'price_category_encoder.pkl'), 'rb'))
        self.room_type_reserved = pickle.load(open(os.path.join(base_dir, 'room_type_reserved_encoder.pkl'), 'rb'))
        self.type_of_meal_plan = pickle.load(open(os.path.join(base_dir, 'type_of_meal_plan_encoder.pkl'), 'rb'))
